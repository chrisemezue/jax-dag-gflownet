...
#SBATCH --output=/home/mila/c/chris.emezue/jax-dag-gflownet/slurm_kde_20_20/main_slurmoutput_ate-%j.txt
#SBATCH --error=/home/mila/c/chris.emezue/jax-dag-gflownet/slurm_kde_20_20/main_slurmerror_ate-%j.txt
...
srun --immediate --exact --ntasks=1 --nodes=1 \
     --output=/home/mila/c/chris.emezue/jax-dag-gflownet/slurm_kde_20_20/slurmoutput_ate_%j_%s.txt \
     --error=/home/mila/c/chris.emezue/jax-dag-gflownet/slurm_kde_20_20/slurmerror_ate_%j_%s.txt \
