...
#SBATCH --output=/home/mila/c/chris.emezue/jax-dag-gflownet/slurm_sc2/main_slurmoutput_ate-%j.txt
#SBATCH --error=/home/mila/c/chris.emezue/jax-dag-gflownet/slurm_sc2/main_slurmerror_ate-%j.txt
...
srun --ntasks=1 \
     --output=/home/mila/c/chris.emezue/jax-dag-gflownet/slurm_sc2/slurmoutput_ate_%j_%s.txt \
     --error=/home/mila/c/chris.emezue/jax-dag-gflownet/slurm_sc2/slurmerror_ate_%j_%s.txt \
